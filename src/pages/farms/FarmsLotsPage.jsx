...
function FarmsLotsPage() {
  ...
  const handleAddFarm = async (farmData) => {
    try {
      if (editingFarm) {
        ...
        if (!res.ok) {
          console.error("Error al actualizar finca:", res.status);
          return;
        }
  ...
  const handleDeleteFarm = async (farmId) => {
    if (
      !window.confirm(
        "¿Seguro que deseas eliminar esta finca? También se eliminarán sus lotes."
      )
    )
      return;
    try {
        ...
        <div className="fl-card">
          ...
          {selectedFarm ? (
            <div className="farm-summary">
              ...
              <p>
                <strong>Ubicación:</strong> {selectedFarm.departamento},{" "}
                {selectedFarm.municipio}, vereda {selectedFarm.vereda}
              </p>
              <p>
              ...
              {selectedFarm.observaciones && (
                <p>
                  <strong>Observaciones:</strong> {selectedFarm.observaciones}
                </p>
              )}
            </div>
          ) : (
